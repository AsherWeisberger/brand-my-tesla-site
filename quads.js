...
const BMT_QUADS = {
  ...
  "aerial": {
    // Nose points left. Artwork reads from the respective end of the vehicle.
    // Trunk stays on the narrow painted deck beyond the rear glass.
    "hood": {"c": [[520,632],[520,364],[397,374],[397,622]], "bow": [[2,0],[0,0],[-2,0],[0,0]], "wrap": [4,3]},
    "trunk": {"c": [[1462,391],[1462,602],[1518,602],[1518,391]], "bow": [[-1,0],[0,0],[1,0],[0,0]], "wrap": [3,2]}
  },
  "rear": {
